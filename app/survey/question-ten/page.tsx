...
export default function QuestionTenPage() {
  ...
  // Реакции на выбор
  const reactions = {
    great: "That's a wonderful approach! The best opportunities often come naturally through relationships and reputation. We'll help you build a presence that attracts the right clients to you effortlessly.",
    bad: "We appreciate your proactive mindset! Taking initiative to seek out opportunities shows great entrepreneurial spirit. Let's help you find the most effective ways to connect with potential clients.",
    exploring: "Finding the right balance is key! Sometimes opportunities come to you, and sometimes you need to go after them. We'll help you discover what works best for your situation and goals."
  };
  ...
  const handleBack = () => {
    ...
    router.push('/survey/question-nine');
  };
  ...
  return (
    <SurveyPageLayout currentStep={13} totalSteps={25}>
      <div className="w-full max-w-2xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <h1 className="font-inter font-semibold text-3xl text-[#080a16] leading-[1.2] text-left">
            I like it when opportunities come to me instead of me actively seeking them out
          </h1>
        </div>
