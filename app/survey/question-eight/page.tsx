...
export default function QuestionEightPage() {
  ...
  // Реакции на выбор
  const reactions = {
    great: "That's a great approach! Working with local clients helps you build strong relationships in your community. Let's keep going and see how we can support you even more!",
    bad: "We understand that national reach can be important too. Let's explore how we can help you find the right balance for your business goals.",
    exploring: "That's perfectly fine! Exploring different approaches is smart. Let's continue and help you discover what works best for your situation."
  };
  ...
  return (
    <SurveyPageLayout currentStep={11} totalSteps={25}>
      <div className="w-full max-w-2xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <h1 className="font-inter font-semibold text-3xl text-[#080a16] leading-[1.2] text-left">
            I want to work with local clients in my town rather than national-wide
          </h1>
        </div>
